 ...
 ****************************************************************************/
	...
	#define HILO_DSR_TRIS           (TRISEbits.TRISE5)
	#define HILO_DSR_IO             (PORTEbits.RE5)
	#define HILO_DCD_TRIS           (TRISEbits.TRISE6)
	#define HILO_DCD_IO             (PORTEbits.RE6)
	#define HILO_CTS_TRIS           (TRISGbits.TRISG7)
	#define HILO_CTS_IO             (PORTGbits.RG7)
	#define HILO_DTR_TRIS           (TRISEbits.TRISE4)
	#define HILO_DTR_IO             (LATEbits.LATE4)
	#define HILO_RI_TRIS            (TRISBbits.TRISB5)
	#define HILO_RI_IO              (PORTBbits.RB5)
    ...
    #define HILO_RESET_TRIS         (TRISEbits.TRISE3)
    #define HILO_RESET_IO           (LATEbits.LATE3)
    #define HILO_RESET_ODC          (ODCEbits.ODE3)
